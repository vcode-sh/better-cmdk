...
function commandScoreInner(
    ...
    var cached = memoizedResults[memoizeKey]
    if (cached !== undefined) {
        return cached
    }
    ...
    var score: number
    var transposedScore: number
    var wordBreaks: RegExpMatchArray | null
    var spaceBreaks: RegExpMatchArray | null
    ...
    while (index >= 0) {
        ...
        if (score > highScore) {
            ...
            if (
                string.charAt(index) !== abbreviation.charAt(abbreviationIndex)
            ) {
